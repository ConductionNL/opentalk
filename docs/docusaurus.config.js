...
const config = createConfig({
  title: 'OpenTalk',
  tagline: 'Nextcloud ExApp packaging for OpenTalk video conferencing. Sidecar containers, integrated with the Nextcloud Talk app.',
  url: 'https://opentalk.conduction.nl',
  baseUrl: '/',

  organizationName: 'ConductionNL',
  projectName: 'opentalk',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://codeberg.org/Conduction/opentalk/src/branch/main/docs/',
        },
        blog: false,
        theme: {
  ...
  navbar: {
    items: [
      ...
      {
        href: 'https://codeberg.org/Conduction/opentalk',
        label: 'Codeberg',
        position: 'right',
      },
